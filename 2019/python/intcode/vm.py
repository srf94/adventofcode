...
class IntcodeVM(object):
    def __init__(self, D, input_=None, mutate_input=None, max_timeout=None, default_input=None):
    ...
    def prep_instruction(self):
        ...
        opcode = i % 100
        self.modes = [(i // 100) % 10, (i // 1000) % 10, (i // 10000) % 10]
        self.args = [self.D.get(self.pointer + 1, 0), self.D.get(self.pointer + 2, 0), self.D.get(self.pointer + 3, 0)]
        return opcode
